...
graph TD
    ...
    %% Estilização
    classDef core fill:#e1f5fe,stroke:#01579b,stroke-width:2px,color:#050505;
    classDef infra fill:#f3e5f5,stroke:#4a148c,stroke-width:2px,color:#050505;
    classDef ext fill:#fff3e0,stroke:#e65100,stroke-width:2px,stroke-dasharray: 5 5,color:#050505;
